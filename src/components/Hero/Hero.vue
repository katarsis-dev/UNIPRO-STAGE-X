<template>
  <div id="hero-section" class="w-full h-[100vh] flex justify-center items-center">
    <div
      ...
      <div
        class="w-[80%]  h-[80dvh] relative m-auto left-0 right-0 top-8 bottom-0 bg-[#161616] rounded-2xl shadow-lg shadow-black -skew-x-12 overflow-hidden group z-10">
        <div
          class="w-full flex justify-center absolute items-center scale-110 h-full rounded-2xl bg-[url(../src/assets/hero-1.jpg)] bg-center bg-cover skew-x-10 grayscale-100 opacity-50  z-5">
        </div>
        <div
