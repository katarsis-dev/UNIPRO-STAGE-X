...
onMounted(() => {
    ...
    const timeline_area = document.getElementsByClassName("timeline-area")[0]

    timeline_area.addEventListener("wheel", (e) => {
        e.preventDefault()
        timeline_area.scrollBy({
        ...
        <div class="w-full text-center py-30 flex justify-center items-center">
            ...
            <div class="w-[90%] flex flex-col justify-center gap-5 ">
                <h1
                    ...
                    TIMELINE</h1>
                <!--Timeline-Content-->
                <div class="timeline_container box_area relative flex justify-center items-center">
                    <!--Card-Container-->
                    <div
